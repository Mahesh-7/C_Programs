...
int main(int argc, char *argv[])
{
    ...
    int nRow = 2; //variable store number of Row
    int nColumn = 3; //variable store number of Row
    int iRow = 2; //Variable for looping Row
    int iCol = 3; //Variable for looping column
